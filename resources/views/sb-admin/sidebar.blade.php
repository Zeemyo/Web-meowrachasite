<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilitiesKucing"
            aria-expanded="true" aria-controls="collapseUtilitiesKucing">
            <i class="fas fa-fw fa-cat"></i>
            <span>Data Kucing</span>
        </a>
        <div id="collapseUtilitiesKucing" class="collapse" aria-labelledby="headingUtilities"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
