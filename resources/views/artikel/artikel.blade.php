  ...
  @foreach ($artikel as $row)
   ...
   <div class="card mt-4 shadow-sm">
    <div style="text-align: center;">
        <img src="/upload/post/{{$row->sampul}}" height="auto" class="card-img-top" alt="..." align-text="center">
    
        <div class="card-body">
            <h3 class="card-title"><strong>{{$row->judul}}</strong></h3>
            </div>
            <small class="card-text">
                <span class="text-muted"><a href="/artikel-kategori/{{$row->kategori->slug}}">Tag: {{$row->kategori->nama}}</a></span>
                -
