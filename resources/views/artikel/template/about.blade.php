...
<div id="about" class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-4">
    <a title="Image from freeiconspng.com"><img src="https://www.freeiconspng.com/uploads/baby-cat-png-12.png" width="350" alt="baby cat png" /></a>
    <!-- <img src="..\artikel\template\c.jpg" alt="Logo" height="60" width="60"> -->
