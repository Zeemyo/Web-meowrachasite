...
<div id="services" class="container-fluid text-center">
  ...
  <br>
    <div class="col-sm-4">
    <a href="/penitipan"><img src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/null/external-pet-carrier-vacation-planning-flaticons-flat-flat-icons.png" width="100" alt="cage face png"/></a>
      <!-- <span class="glyphicon glyphicon-home logo-small"></span> -->
      <h4>PENITIPAN</h4>
      <p>Melayani jasa penitipan kucing harian dengan pelayanan terpercaya. Kesehatan, kenyamanan, dan kebahagiaan anabul kamu adalah prioritas kami</p>
    </div>
    <div class="col-sm-4">
    <a href="/adopsi" title="Image from freeiconspng.com"><img src="https://www.freeiconspng.com/uploads/cat-face-png-31.png" width="90" alt="cat face png" /></a>
